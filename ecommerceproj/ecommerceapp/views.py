...
from ecommerceapp.forms import UserRegisterForm,LoginForm,CartForm,OrderForm
from django.contrib.auth.models import User
from django.contrib import messages
from django.http import HttpResponse
from django.contrib.auth import authenticate,login,logout
from ecommerceapp.models import Products,Carts,Orders
...
class ProductDetailView(View):
    def get(self,request,*args,**kwargs):
        ...
        return render(request,'product_detail.html',{'product_product':product})
...
class AddToCartView(View):
    def get(self,request,*args,**kwargs):
        ...
        id=kwargs.get('id')
        product=Products.objects.get(id=id)       
        return render(request,'add_tocart.html',{'form':form,'product':product})
